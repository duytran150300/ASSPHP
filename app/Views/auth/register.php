...
<body>
    <div class="container">
        ...
        <form action="<?= ROOT_PATH ?>register" method="post" class="content">
            <h1>Register</h1>
            <div class="form-group">
                <label for="">Phone Number</label>
                <input type="text" class="form-control" name="phone" id="txt" aria-describedby="helpId" placeholder="Phone" required>
