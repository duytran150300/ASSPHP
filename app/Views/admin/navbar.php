            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= ROOT_PATH ?>admin/category">
                                <i class="fa-solid fa-layer-group"></i> Categories
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= ROOT_PATH ?>admin/product">
                                <i class="fa-solid fa-people-carry-box"></i> Products
                                <span class="badge bg-soft-primary text-primary rounded-pill d-inline-flex align-items-center ms-auto">6</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <i class="fa-solid fa-money-bill-wave"></i>Bills
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">MACHI SHOP</h1>
                            </div>
                            <!-- Actions -->
